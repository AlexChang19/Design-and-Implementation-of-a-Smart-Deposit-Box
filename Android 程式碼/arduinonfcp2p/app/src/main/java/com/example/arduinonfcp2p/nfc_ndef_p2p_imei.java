...
public class nfc_ndef_p2p_imei extends AppCompatActivity {

    NfcAdapter nNfcAdapter;
    private   TextView Message_Beam;
    public  String MIMETYPE = " ";
    public  String ndef_data_in="0";
    private static  final  int BEAM_BEAMED = 0x1001;
    private final String TAG = nfc_ndef_p2p_imei.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MIMETYPE = tnf_str;
        Ndefinfornation.setText(ndef_data_in);
        ...
        nNfcAdapter.setNdefPushMessageCallback(new NfcAdapter.CreateNdefMessageCallback(){
           ...
           public NdefMessage createNdefMessage(NfcEvent event){
                   String Message = ndef_data_in.toString();
                   String text = (Message);
        ...
        back_select_method.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent i = new Intent();
                i.setClass(nfc_ndef_p2p_imei.this, select_login_method.class);
                startActivity(i);
                finish();
            }
        });
